package lter.limnology.wisc.edu.newlakeconditions.provider.Cache;
...
import lter.limnology.wisc.edu.newlakeconditions.provider.WeatherContract;
import lter.limnology.wisc.edu.newlakeconditions.provider.WeatherContract.WeatherValuesEntry;
...
public class WeatherTimeoutCache
    ...
    public void removeExpiredWeatherData() {
        ...
        // Use the expired data id's to delete the designated entries from table.
        if (expiredData != null
