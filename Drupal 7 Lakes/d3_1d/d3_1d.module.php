...
function d3_1d_menu() {
  ...
  $items['1dPlot/%/%'] = array(
    'title' => '',
    'page callback' => 'd3_1d_basic', //php function name
...
function d3_1d_basic($lakeid,$variable) {
  ...
  $content['div_container']['css_content'] = array(
    ...
    '#attached' => array(
      'css' => array(
        drupal_get_path('module','d3_1d').'/d3_1d.css',
      ),
    ),  
  );
  ...
  $content['div_container']['js_content'] = array(
    ...
    '#attached' => array(
      'js' => array(
        drupal_get_path('module','d3_1d').'/1dplot.js',
        array(
 	      'type' => 'setting', 
	      'data' => array(
