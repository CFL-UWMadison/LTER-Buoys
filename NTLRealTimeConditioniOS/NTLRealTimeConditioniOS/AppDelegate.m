...
// It's necessary to remember that the rootviewcontroller will not call viewDidLoad if it enters the foreground
// again. That method will only be called if the app get terminated, and get turned on again.
- (void)applicationWillEnterForeground:(UIApplication *)application {
    RootViewController* rvc = (RootViewController* )self.window.rootViewController;
    [rvc displayFavouriteAsFirstPage];
    [rvc startWeatherDBTimer];
    [[UserSetting sharedSetting] loadUserSetting];
