	...
	<tbody>
		<tr>
			<td colspan="3">
				...
				<p style="color:red"><b>The Trout Bog buoy is offline for the winter</b></p>
		...
		<tr>
			<td style=" border: 7px solid #006699; text-align: center;">
				<br />
				<a href="https://lter.limnology.wisc.edu/page/water-temperate-plot?lake=TB"><font size="4">Water Temperatures</font></a><br />
				<br />
				<font size="4">&nbsp;<?php echo substr($temp_f,0,4);?>&nbsp;(&deg;F)<br />
				<?php echo substr($temp[0],0,4);?>&nbsp;(&deg;C)</font></td>
			<td style="border: 7px solid #006699; text-align: center;">
				<a href="https://lter.limnology.wisc.edu/page/temperature-map?lake=TB"><font size="4">Water Temperature Heat Map</font></a></td>
			<td style=" border: 7px solid #006699; text-align: center;">
				<br />
		...
		<tr>
			<td style=" border: 7px solid #006699; text-align: center;">
				<br />
				<a href="../lakeinfo/chemistry-data?lakeid=TB&amp;chem=totnuf"><font size="3">Total<br />
				Nitrogen</font></a><br />
				&nbsp;</td>
			<td style=" border: 7px solid #006699; text-align: center;">
				<br />
				<a href="../lakeinfo/chemistry-data?lakeid=TB&amp;chem=totpuf"><font size="3">Total<br />
				Phosphorus</font></a><br />
				&nbsp;</td>
			<td style=" border: 7px solid #006699; text-align: center;">
				<br />
				<a href="../lakeinfo/chemistry-data?lakeid=TB&amp;chem=doc"><font size="3">Dissolved<br />
		...
		<tr>
			<td style=" border: 7px solid #006699;">
				<a href="../lakeinfo/fish-species?lakeid=TB"><img alt="fish icon" src="/sites/default/files/ntl/images/lakes/fishIcon.jpg" style="width: 100px; height: 64px; margin: 10px;" /></a></td>
			<td style=" border: 7px solid #006699;">
				<a href="../lakeinfo/phytoplankton-species?lakeid=TB"><img alt="phytoplankton icon" src="/sites/default/files/ntl/images/lakes/phytoplanktonIcon.jpg" style="width: 100px; height: 64px; margin: 10px;" /></a></td>
			<td style=" border: 7px solid #006699;">
				<a href="../lakeinfo/zooplankton-species?lakeid=TB"><img alt="zooplankton icon" src="/sites/default/files/ntl/images/lakes/zooplanktonIcon.jpg" style="width: 100px; height: 64px; margin: 10px;" /></a></td>
			<td style=" border: 7px solid #006699; text-align: center;">
				<br />
				<a href="../lakeinfo/chemistry-data?lakeid=TB&amp;chem=chlor"><font size="3">Chlorophyll<br />
		...
		<tr>
			<td style=" border: 7px solid #006699;">
				<a href="../lakeinfo/ice-data?lakeid=TB"><img alt="ice icon" src="/sites/default/files/ntl/images/lakes/iceIcon.jpg" style="width: 100px; height: 64px; margin: 10px; float: left;" /></a></td>
			<td style=" border: 7px solid #006699;">
				<a href="../lakeinfo/lake-levels?lakeid=TB&amp;system=NTL"><img alt="ice icon" src="/sites/default/files/ntl/images/lakes/waterlevelIcon.jpg" style="width: 100px; height: 64px; margin: 10px; float: left;" /></a></td>
			<td style=" border: 7px solid #006699;">
				<a href="../lakeinfo/secchi-depths?lakeid=TB"><img alt="ice icon" src="/sites/default/files/ntl/images/lakes/secchiIcon.jpg" style="width: 100px; height: 64px; margin: 10px; float: left;" /></a></td>
		</tr>
	</tbody>
</table>
<p>&nbsp;</p>
